...
namespace NetworkUtil
{
  ...
  public class NetworkTestHelper
  {
    ...
    public static SocketState serv;
    ...
    public static void SetupSingleConnectionTest(out TcpListener listener, out SocketState client, out SocketState server)
    {
      ...
      tcp = listener;
        ...
        public static void AddAnotherClient(out TcpListener listener, out SocketState client)
        {
            SocketState clientResult = null;
            ...
            WaitForOrTimeout(() => (clientResult != null) && (serv != null), timeout);
            client = clientResult;
